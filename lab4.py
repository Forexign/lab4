...
while num1 < 1 or num1 > 999:
    num1 = int(input(" WARNING! Please enter a number between 1-999 (inclusive) for the first number: "))

num2 = int(input("Enter the second number between 1-999 (inclusive): "))
while num2 < 1 or num2 > 999 or num2 >= num1:
    num2 = int(input(
        "WARNING! Please enter a number between 1-999 (inclusive) and less than the first number for the second number: "))
...
# Randomly chooses words from the words array as chosen above.
password = ""
...
all_passwords = longer.union(shorter)
print("All the 8 passwords created are : ", all_passwords)
...
print("Sum of the all values in myDict is ", sum)

# Question 4-d

user_input = int(input("Enter the key that you want to delete: "))
if user_input in myDict:
    print(user_input, ":", myDict[user_input], "pair is deleted.")
    del myDict[user_input]
else:
    print("The key you have entered doesn't exist in the dictionary.")
...
print("AFTER THE DELETION OF THE KEY 'NAT'")
